...
import (
	...
	comatprototypes "github.com/naschat/indigo/api/atproto"
	appbsky "github.com/naschat/indigo/api/bsky"
	lexutil "github.com/naschat/indigo/lex/util"
)
...
func newProfileViewDetailed() *appbsky.ActorDefs_ProfileViewDetailed {
	return &appbsky.ActorDefs_ProfileViewDetailed{
		...
		Avatar:         strPtr("https://cdn.naschatai.com/img/avatar/plain/a@jpeg"),
...
func TestBuildPostJSONLD_Bare(t *testing.T) {
	...
	canonical := "https://naschatai.com/profile/alice.bsky.social/post/abc123"
...
func TestBuildPostJSONLD_WithImages(t *testing.T) {
	thumb1 := "https://cdn.naschatai.com/img/feed_thumbnail/plain/did:plc:alice/abc@jpeg"
	thumb2 := "https://cdn.naschatai.com/img/feed_thumbnail/plain/did:plc:alice/def@jpeg"
	pv := makePostView("alice.bsky.social", "did:plc:alice", "abc123", "look", withImages(thumb1, thumb2))
	out, err := buildPostJSONLD(pv, nil, "https://naschatai.com/profile/alice.bsky.social/post/abc123", hideEmbedLabels, hideReplyLabels)
	if err != nil {
		t.Fatal(err)
	}
...
func TestBuildPostJSONLD_WithVideo(t *testing.T) {
	thumb := "https://cdn.naschatai.com/img/video_thumbnail/plain/did:plc:alice/v@jpeg"
...
func TestBuildPostJSONLD_QuotePost(t *testing.T) {
	...
	out, _ := buildPostJSONLD(pv, nil, "u", hideEmbedLabels, hideReplyLabels)
	main := unmarshalLD(t, out)["mainEntity"].(map[string]any)
	if main["isBasedOn"] != "https://naschatai.com/profile/bob.example.com/post/xyz" {
...
func TestBuildPostJSONLD_HiddenEmbed(t *testing.T) {
	thumb := "https://cdn.naschatai.com/img/x@jpeg"
...
func TestBuildPostJSONLD_HandleInvalidAuthor(t *testing.T) {
	...
	fallback := "https://naschatai.com/profile/did:plc:alice/post/abc123"
...
func TestBuildPostJSONLD_EnvelopeURLMatchesMainEntity(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			did:       "did:plc:alice",
			rkey:      "abc",
			canonical: "https://naschatai.com/profile/alice.bsky.social/post/abc",
		},
		{
			...
			did:       "did:plc:alice",
			rkey:      "abc",
			canonical: "https://naschatai.com/profile/did:plc:alice/post/abc",
		},
	}
...
func TestBuildPostJSONLD_CommentMedia(t *testing.T) {
	...
	pv := makePostView("alice.bsky.social", "did:plc:alice", "abc123", "main")
	*pv.ReplyCount = 1
	thumb := "https://cdn.naschatai.com/img/feed_thumbnail/plain/did:plc:bob/x@jpg"
...
func TestBskyPostURL(t *testing.T) {
	tests := []struct {
		...
		{"valid", "alice.bsky.social", "abc", "https://naschatai.com/profile/alice.bsky.social/post/abc"},
		{"empty handle", "", "abc", ""},
...
func TestBskyPostURLFromATURI(t *testing.T) {
	tests := []struct {
		...
		{"valid", "alice.bsky.social", "at://did:plc:alice/app.bsky.feed.post/abc", "https://naschatai.com/profile/alice.bsky.social/post/abc"},
...
func TestBskyProfileURL(t *testing.T) {
	if bskyProfileURL("alice.bsky.social") != "https://naschatai.com/profile/alice.bsky.social" {
...
func TestBuildReviewedBy_NameFallbacks(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			wantURL:           "https://naschatai.com/profile/alice.example.com",
		...
		},
		{
			...
			wantAlternateName: "",
			wantURL:           "https://naschatai.com/profile/bob.example.com",
		...
		},
		{
			...
			wantAlternateName: "",
			wantURL:           "https://naschatai.com/profile/did:plc:v3",
		...
		},
		{
			...
			wantAlternateName: "",
			wantURL:           "https://naschatai.com/profile/did:plc:v4",
...
func TestBuildPostJSONLD_AuthorReviewedBy(t *testing.T) {
	...
	if v["url"] != "https://naschatai.com/profile/verifier.example.com" {
