...
import (
	...
	chat "github.com/naschat/indigo/api/chat"
	"github.com/naschat/indigo/atproto/syntax"
	"github.com/naschat/indigo/util/cliutil"
	"github.com/naschat/indigo/xrpc"
...
func serve(cctx *cli.Context) error {
	...
	e.Use(middleware.RateLimiterWithConfig(middleware.RateLimiterConfig{
		...
		DenyHandler: func(c echo.Context, identifier string, err error) error {
			return c.String(http.StatusTooManyRequests, "Your request has been rate limited. Please try again later. Contact security@naschatai.com if you believe this was a mistake.\n")
		},
	}))
	...
	// enable some special endpoints for the "canonical" deployment (naschatai.com). not having these enabled should *not* impact regular operation
...
func (srv *Server) Download(c echo.Context) error {
	...
	if strings.Contains(ua, "Android") {
		return c.Redirect(http.StatusFound, "https://play.google.com/store/apps/details?id=com.naschat.app")
	}

	if strings.Contains(ua, "iPhone") || strings.Contains(ua, "iPad") || strings.Contains(ua, "iPod") {
		return c.Redirect(http.StatusFound, "https://apps.apple.com/tr/app/naschat/id6444370199")
	}
