...
func TestRenderPost_EmitsJSONLD(t *testing.T) {
	...
	ld, err := buildPostJSONLD(pv, nil, "https://naschatai.com/profile/alice.bsky.social/post/abc123", hideEmbedLabels, hideReplyLabels)
	if err != nil {
		t.Fatal(err)
	}
	html := renderTemplate(t, "post.html", pongo2.Context{
		"postView":     pv,
		"requestURI":   "https://naschatai.com/profile/alice.bsky.social/post/abc123",
		"canonicalURL": "https://naschatai.com/profile/alice.bsky.social/post/abc123",
		"postJSONLD":   ld,
	})
	...
	if !strings.Contains(html, `<link rel="canonical" href="https://naschatai.com/profile/alice.bsky.social/post/abc123" />`) {
...
func TestRenderPost_OGImageMatchesJSONLD(t *testing.T) {
	...
	ld, _ := buildPostJSONLD(pv, nil, "https://naschatai.com/profile/alice.bsky.social/post/abc123", hideEmbedLabels, hideReplyLabels)
	html := renderTemplate(t, "post.html", pongo2.Context{
		"postView":     pv,
		"requestURI":   "https://naschatai.com/profile/alice.bsky.social/post/abc123",
		"canonicalURL": "https://naschatai.com/profile/alice.bsky.social/post/abc123",
...
func TestRenderPost_FallsBackToCanonicalizeFilter(t *testing.T) {
	...
	html := renderTemplate(t, "post.html", pongo2.Context{
		"postView":   pv,
		"requestURI": "https://naschatai.com/profile/alice.bsky.social/post/abc123?utm=foo",
		"postJSONLD": ld,
	})
	if !strings.Contains(html, `<link rel="canonical" href="https://naschatai.com/profile/alice.bsky.social/post/abc123" />`) {
...
func TestRenderProfile_EmitsJSONLD(t *testing.T) {
	...
	html := renderTemplate(t, "profile.html", pongo2.Context{
		"profileView":   pv,
		"requestURI":    "https://naschatai.com/profile/alice.bsky.social",
		"canonicalURL":  "https://naschatai.com/profile/alice.bsky.social",
		"profileJSONLD": ld,
	})
...
func TestRenderPost_OGUrlMatchesCanonical(t *testing.T) {
	...
	html := renderTemplate(t, "post.html", pongo2.Context{
		"postView":     pv,
		"requestURI":   "https://naschatai.com/profile/did:plc:alice/post/abc123",
	...
	if strings.Contains(html, `<meta property="og:url" content="https://naschatai.com/profile/did:plc:alice/post/abc123">`) {
...
func TestRenderPost_VideoWithoutThumbnailEmitsOGVideo(t *testing.T) {
	...
	ld, _ := buildPostJSONLD(pv, nil, "u", hideEmbedLabels, hideReplyLabels)
	videoURL := "https://video.naschatai.com/v.m3u8"
	html := renderTemplate(t, "post.html", pongo2.Context{
		"postView":     pv,
		"requestURI":   "https://naschatai.com/profile/alice.bsky.social/post/abc123",
		"canonicalURL": "https://naschatai.com/profile/alice.bsky.social/post/abc123",
