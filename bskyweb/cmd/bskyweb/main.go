...
func run(args []string) {
	...
	app := cli.App{
		Name:  "bskyweb",
		Usage: "web server for naschatai.com web app (SPA)",
	}
		...
		&cli.Command{
			...
			Flags: []cli.Flag{
				...
				&cli.StringSliceFlag{
					...
					Required: false,
					Value:    cli.NewStringSlice("https://naschatai.com", "https://main.bsky.dev", "https://app.staging.bsky.dev"),
				...
				&cli.BoolFlag{
					...
					Usage:    "Enable if this is the canonical deployment (naschatai.com)",
					Value:    false,
					Required: false,
