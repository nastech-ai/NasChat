...
import (
	...
	"github.com/naschat/indigo/atproto/identity"
...
func serve(cctx *cli.Context) error {
	...
	e.Use(middleware.RateLimiterWithConfig(middleware.RateLimiterConfig{
		...
		DenyHandler: func(c echo.Context, identifier string, err error) error {
			return c.String(http.StatusTooManyRequests, "Your request has been rate limited. Please try again later. Contact support@naschatai.com if you believe this was a mistake.\n")
		},
	}))
