...
* URL scheme: `https://naschatai.com/profile/*/post/*`
* API endpoint: `https://embed.naschatai.com/oembed`

Request params:

- `url` (required): support both AT-URI and naschatai.com URL
...
- `provider_name` (optional): "NasChat"
- `provider_url` (optional): "https://naschatai.com"
...
```
<link rel="alternate" type="application/json+oembed" href="https://embed.naschatai.com/oembed?format=json&url=https://naschatai.com/profile/bnewbold.net/post/abc123" />
```


## iframe URL

`https://embed.naschatai.com/embed/<did>/app.bsky.feed.post/<rkey>`
`https://embed.naschatai.com/static/embed.js`

```
<blockquote class="naschat-post" data-lang="en" data-align="center">
