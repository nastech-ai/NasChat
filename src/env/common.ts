...
/**
 * The DID of the NasChat appview to proxy to
 */
export const NASCHAT_PROXY_DID: Did =
  process.env.EXPO_PUBLIC_NASCHAT_PROXY_DID || 'did:web:api.naschat.app'
...
export const METRICS_API_HOST: string =
  process.env.EXPO_PUBLIC_METRICS_API_HOST || 'https://events.naschat.app'
...
export const GEOLOCATION_PROD_URL = `https://ip.naschat.app`
...
export const LIVE_EVENTS_PROD_URL = `https://live-events.workers.naschat.app`
...
export const APP_CONFIG_PROD_URL = `https://app-config.workers.naschat.app`
