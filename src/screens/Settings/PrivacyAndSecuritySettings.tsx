            ...
            <Admonition.Outer type="tip" style={[a.flex_1]}>
              <Admonition.Row>
                ...
                <Admonition.Content>
                  <Admonition.Text>
                    <Trans>
                      Note: NasChat is an open and public network. This setting
                      only limits the visibility of your content on the NasChat
                  ...
                  <Admonition.Text>
                    <InlineLinkText
                      label={_(
                        msg`Learn more about what is public on NasChat.`,
                      )}
                      to="https://naschat.zendesk.com/hc/en-us/articles/15835264007693-Data-Privacy">
                      <Trans>Learn more about what is public on NasChat.</Trans>
                    </InlineLinkText>
                  </Admonition.Text>
                </Admonition.Content>
              </Admonition.Row>
