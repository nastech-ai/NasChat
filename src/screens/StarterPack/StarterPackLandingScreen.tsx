    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join NasChat`)}
              onPress={onJoinPress}
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join NasChat</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.Content>
          <Prompt.TitleText>
            <Trans>Download NasChat</Trans>
          </Prompt.TitleText>
          <Prompt.DescriptionText>
            <Trans>
              The experience is better in the app. Download NasChat now and
      ...
      {IS_WEB && (
        <meta
          ...
          content="app-id=com.naschat.app, app-clip-bundle-id=com.naschat.app.AppClip, app-clip-display=card"
        />
      )}
    </View>
  )
      ...
      <View style={[a.flex_1, a.px_lg, {marginTop: 250}]}>
        ...
        <View style={[a.gap_md, {zIndex: 2}]}>
          <Text
            ...
            Download NasChat to get started!
          </Text>
