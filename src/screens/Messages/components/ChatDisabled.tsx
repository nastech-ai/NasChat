...
import {NASCHAT_MOD_SERVICE_HEADERS} from '#/lib/constants'
    ...
    mutationFn: async () => {
      ...
      await agent.createModerationReport(
        ...
        },
        {
          ...
          headers: NASCHAT_MOD_SERVICE_HEADERS,
        },
      )
    },
    onError: err => {
  ...
  return (
    <Dialog.ScrollableInner label={l`Appeal this decision`}>
      ...
      <Text style={[a.text_md, a.leading_snug]}>
        <Trans>This appeal will be sent to NasChat's moderation service.</Trans>
      </Text>
      <View style={[a.my_md]}>
        <Dialog.Input
