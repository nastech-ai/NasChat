  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined NasChat using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined NasChat ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined NasChat using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined NasChat ${timeAgoString} ago`)
      }
    }
  }
