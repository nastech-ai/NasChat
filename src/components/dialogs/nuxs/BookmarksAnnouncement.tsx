          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                alt={_(
                  msg({
                    message: `A screenshot of a post with a new button next to the share button that allows you to save the post to your bookmarks. The post is from @jcsalterego.naschatai.com and reads "inventing a saturday that immediately follows monday".`,
                    comment:
