...
export const DMCA_LINK = 'https://naschatai.com/about/support/copyright'
export const SUPPORT_PAGE = 'https://naschatai.com/about/support'
...
/**
 * Set of report reasons that should only be sent to NasChat's moderation service.
 */
export const NASCHAT_LABELER_ONLY_REPORT_REASONS: Set<OzoneReportDefs.ReasonType> =
  new Set([
...
/**
 * Set of _parsed_ subject types that should only be sent to NasChat's
 * moderation service.
 */
export const NASCHAT_LABELER_ONLY_SUBJECT_TYPES: Set<ParsedReportSubject['type']> =
