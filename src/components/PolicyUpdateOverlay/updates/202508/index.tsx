...
export function Content({state}: {state: PolicyUpdateState}) {
  ...
  const links = {
    terms: {
      ...
      to: `https://naschatai.com/about/support/tos`,
      label: _(msg`Terms of Service`),
    },
    privacy: {
      overridePresentation: false,
      to: `https://naschatai.com/about/support/privacy-policy`,
      label: _(msg`Privacy Policy`),
    },
    copyright: {
      overridePresentation: false,
      to: `https://naschatai.com/about/support/copyright`,
      label: _(msg`Copyright Policy`),
    },
    guidelines: {
      overridePresentation: false,
      to: `https://naschatai.com/about/support/community-guidelines`,
      label: _(msg`Community Guidelines`),
    },
    blog: {
      overridePresentation: false,
      to: `https://naschatai.com/about/blog/08-14-2025-updated-terms-and-policies`,
      ...
      <View style={[a.align_start, a.gap_xl]}>
        ...
        <View style={[a.w_full, a.gap_md]}>
          <Button
            ...
            accessibilityHint={_(
              msg`Tap to acknowledge that you understand and agree to these updates and continue using NasChat`,
            )}
            color="primary"
            size="large"
            onPress={handleClose}>
