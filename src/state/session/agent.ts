...
import {
  NASCHAT_PROXY_HEADER,
  NASCHAT_SERVICE,
  DISCOVER_SAVED_FEED,
  IS_PROD_SERVICE,
  PUBLIC_NASCHAT_SERVICE,
  TIMELINE_SAVED_FEED,
} from '#/lib/constants'
...
export function createPublicAgent() {
  ...
  const agent = new BskyAppAgent({service: PUBLIC_NASCHAT_SERVICE})
  agent.configureProxy(NASCHAT_PROXY_HEADER.get())
  return agent
}
...
export function agentToSessionAccount(
  ...
  return {
    ...
    isSelfHosted: !agent.serviceUrl.toString().startsWith(NASCHAT_SERVICE),
  }
}
