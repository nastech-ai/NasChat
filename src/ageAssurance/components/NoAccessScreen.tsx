                ...
                {isAARegion ? (
                  <>
                    <View style={[a.gap_lg]}>
                      ...
                      <Text style={[textStyles]}>
                        <Trans>
                          You are accessing NasChat from a region that legally
                      ...
                      {!aa.flags.isOverRegionMinAccessAge && (
                        <Text style={[textStyles]}>
                          <Trans>
                            ...
                            are not old enough to access NasChat in your region.
                          </Trans>
                        </Text>
                      )}
                  ...
                  <View style={[a.gap_lg]}>
                    <Text style={[textStyles]}>
                      <Trans>
                        ...
                        profile makes you too young to access NasChat.
                      </Trans>
                    </Text>
      ...
      <View style={[a.gap_xl]}>
        {isBlocked ? (
          <Admonition type="warning">
            <Trans>
              You are currently unable to access NasChat's Age Assurance flow.
              Please{' '}
              <SimpleInlineLinkText
