  ...
  feed: [
    {
      post: {
        ...
        author: {
          ...
          handle: 'forkedriverband.naschatai.com',
          displayName: 'Forked River Band',
          avatar: 'https://naschatai.com/about/adi/post_1_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
        ...
        embed: {
          ...
          images: [
            {
              thumb: 'https://naschatai.com/about/adi/post_1_image.jpg',
              fullsize: 'https://naschatai.com/about/adi/post_1_image.jpg',
              alt: 'Fake flier for Sebastapol Bluegrass Fest',
              aspectRatio: {
                height: 1350,
                width: 900,
    ...
    },
    {
      post: {
        ...
        author: {
          ...
          handle: 'dinh-designs.naschatai.com',
          displayName: 'Rich Dinh Designs',
          avatar: 'https://naschatai.com/about/adi/post_2_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
        ...
        embed: {
          ...
          images: [
            {
              thumb: 'https://naschatai.com/about/adi/post_2_image.jpg',
              fullsize: 'https://naschatai.com/about/adi/post_2_image.jpg',
              alt: 'Placeholder image of interior design',
              aspectRatio: {
                height: 872,
                width: 598,
    ...
    },
    {
      post: {
        ...
        author: {
          ...
          handle: 'rodyalbuerne.naschatai.com',
          displayName: 'Rody Albuerne',
          avatar: 'https://naschatai.com/about/adi/post_3_avi.jpg',
          viewer: {
            muted: false,
            blockedBy: false,
...
export const BOTTOM_BAR_AVI = 'https://naschatai.com/about/adi/user_avi.jpg'
