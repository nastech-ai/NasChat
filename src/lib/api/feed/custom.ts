...
import {createBskyTopicsHeader, isNasChatOwnedFeed} from './utils'
...
export class CustomFeedAPI implements FeedAPI {
  ...
  async fetch({
    ...
    const isNasChatOwned = isNasChatOwnedFeed(this.params.feed)
...
async function loggedOutFetch({
  ...
  let res = await fetch(
    `https://api.naschatai.com/xrpc/app.bsky.feed.getFeed?feed=${feed}${
