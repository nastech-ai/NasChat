...
import {NASCHAT_PROXY_DID, CHAT_PROXY_DID, IS_DEV} from '#/env'

export const LOCAL_DEV_SERVICE =
  Platform.OS === 'android' ? 'http://10.0.2.2:2583' : 'http://localhost:2583'
export const STAGING_SERVICE = 'https://staging.bsky.social'
export const NASCHAT_SERVICE = 'https://bsky.social'
export const NASCHAT_SERVICE_DID = 'did:web:bsky.social'
export const PUBLIC_NASCHAT_SERVICE = 'https://public.api.bsky.app'
export const DEFAULT_SERVICE = NASCHAT_SERVICE
const HELP_DESK_LANG = 'en-us'
export const HELP_DESK_URL = `https://naschatai.zendesk.com/hc/${HELP_DESK_LANG}`
export const CHAT_SERVICE = 'https://api.bsky.chat'
export const EMBED_SERVICE = 'https://embed.bsky.app'
export const EMBED_SCRIPT = `${EMBED_SERVICE}/static/embed.js`
export const NASCHAT_DOWNLOAD_URL = 'https://naschatai.com/download'
...
export const DISCOVER_DEBUG_DIDS: Record<string, true> = {
  ...
  'did:plc:p2cp5gopk7mgjegy6wadk3ep': true, // samuel.naschat.team
  'did:plc:ragtjsm2j2vknwkz3zp4oxrd': true, // pfrazee.com
  'did:plc:vpkhqolt662uhesyj6nxm7ys': true, // why.naschat.team
  'did:plc:3jpt2mvvsumj2r7eqk4gzzjz': true, // esb.lol
  'did:plc:vjug55kidv6sye7ykr5faxxn': true, // emilyliu.me
  'did:plc:tgqseeot47ymot4zro244fj3': true, // iwsmith.naschatai.com
  'did:plc:2dzyut5lxna5ljiaasgeuffz': true, // darrin.naschat.team
}
...
export const STATUS_PAGE_URL = 'https://status.naschatai.com/'
...
export const GIF_SERVICE = 'https://gifs.naschat.app'
...
export const VIDEO_SERVICE = 'https://video.naschat.app'
export const VIDEO_SERVICE_DID = 'did:web:video.naschat.app'
  ...
  website: {
    blog: {
      findFriendsAnnouncement:
        'https://naschatai.com/about/blog/12-16-2025-find-friends',
      initialVerificationAnnouncement: `https://naschatai.com/about/blog/04-21-2025-verification`,
      searchTipsAndTricks: 'https://naschatai.com/about/blog/05-31-2024-search',
    },
    support: {
      findFriendsPrivacyPolicy:
        'https://naschatai.com/about/support/find-friends-privacy-policy',
    },
  },
}

export const PUBLIC_APPVIEW = 'https://api.naschat.app'
export const PUBLIC_APPVIEW_DID = 'did:web:api.naschat.app'
export const PUBLIC_STAGING_APPVIEW_DID = 'did:web:api.staging.naschatai.com'

export const DEV_ENV_APPVIEW = `http://localhost:2584` // always the same
export const DEV_ENV_APPVIEW_DID = `did:plc:dw4kbjf5mn7nhenabiqpkyh3` // always the same

// temp hack for e2e - esb
export const NASCHAT_PROXY_HEADER = {
  value: `${NASCHAT_PROXY_DID}#bsky_appview`,
  get() {
...
export const NASCHAT_MOD_SERVICE_HEADERS = {
  'atproto-proxy': `${BSKY_LABELER_DID}#atproto_labeler`,
}

export const NASCHAT_NOTIF_SERVICE_HEADERS = {
  'atproto-proxy': `${NASCHAT_PROXY_DID}#bsky_notif`,
}

export const webLinks = {
  tos: `https://naschatai.com/about/support/tos`,
  privacy: `https://naschatai.com/about/support/privacy-policy`,
  community: `https://naschatai.com/about/support/community-guidelines`,
  communityDeprecated: `https://naschatai.com/about/support/community-guidelines-deprecated`,
}
