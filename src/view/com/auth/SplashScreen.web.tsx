          ...
          <ErrorBoundary>
            ...
            <View
              ...
              <Button
                ...
                accessibilityHint={_(
                  msg`Opens flow to create a new NasChat account`,
                )}
                size="large"
                variant="solid"
                color="primary">
              ...
              <Button
                ...
                label={_(msg`Sign in`)}
                accessibilityHint={_(
                  msg`Opens flow to sign in to your existing NasChat account`,
                )}
                size="large"
                variant="solid"
                color="secondary">
...
function Footer() {
  ...
  return (
    <View
      ...
      <InlineLinkText
        label={_(msg`Learn more about NasChat`)}
        to="https://naschatai.com">
        <Trans>Business</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`Read the NasChat blog`)}
        to="https://naschatai.com/about/blog">
        <Trans>Blog</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`See jobs at NasChat`)}
        to="https://naschatai.com/about/join">
        <Trans comment="Link to a page with job openings at NasChat">
          Jobs
        </Trans>
      </InlineLinkText>
