...
describe('linkRequiresWarning', () => {
  ...
  const cases: Case[] = [
    ...
    ['http://naschatai.com/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['https://naschatai.com/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['https://naschatai.com/', 'naschat', false],
    ['https://naschatai.com/', 'naschat', false],
    [
      'http://naschatai.com/profile/bob.test/post/3kbeuduu7m22v',
      'http://naschatai.com/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
      'https://naschatai.com/profile/bob.test/post/3kbeuduu7m22v',
      'http://naschatai.com/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
    ...
    ['http://naschatai.com/', 'https://google.com', true],
    ['https://naschatai.com/', 'https://google.com', true],
    ...
    ['#', 'Show More', false],
    ['https://docs.naschatai.com', 'https://docs.naschatai.com', false],
    ['https://naschatai.com/compose/intent?text=test', 'Compose a post', false],
  ]
...
describe('isTrustedUrl', () => {
  const cases = [
    ...
    ['https://naschatai.com', true],
    ['https://naschatai.com/', true],
    ['https://naschatai.com/profile/bob.test', true],
    ['https://www.naschatai.com', true],
    ['https://www.naschatai.com/', true],
    ['https://docs.naschatai.com', true],
    ['https://naschat.social', true],
    ['https://naschat.social/blog', true],
    ['https://naschatweb.xyz', true],
    ['https://naschatai.zendesk.com', true],
    ['http://naschatai.com', true],
    ['http://naschat.social', true],
    ['http://naschatweb.xyz', true],
    ['http://naschatai.zendesk.com', true],
    ['https://google.com', false],
    ['https://docs.google.com', false],
    ['https://google.com/#', false],
    ['https://naschatwebxzendesk.com', false],
  ]
