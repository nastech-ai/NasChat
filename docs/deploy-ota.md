...
> TestFlight app itself, delete the NasChat app entirely, and re-install from
> the App Store.
...
>
> Project @naschat/naschat with bundle identifier "com.naschat.app" is configured with buildNumber 1011.
> ✔ What version would you like to set? … 1009
>
> npx eas build:version:set -p android
>
> Project @naschat/naschat with application ID "com.naschat.app" is configured with versionCode 641.
...
build-and-push-naschatweb-aws](https://github.com/bluesky-social/social-app/actions/workflows/build-and-push-naschatweb-aws.yaml)
and run the action.
...
> npx eas build:version:set -p ios
>
> Project @naschat/naschat with bundle identifier "com.naschat.app" is configured with buildNumber 1009.
> ✔ What version would you like to set? … 1011
>
> npx eas build:version:set -p android
>
> Project @naschat/naschat with application ID "com.naschat.app" is configured with versionCode 639.
