...
We want the official NasChat app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://naschat.crowdin.com/naschat) or open an issue on the [NasChat app repo on GitHub](https://github.com/bluesky-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - NasChat Crowdin: https://naschat.crowdin.com/naschat
...
[Crowdin](https://naschat.crowdin.com/naschat) is our primary tool for managing translations. There are two roles:
...
You can request a new language be added to the project by clicking **Request New Language** on [Crowdin](https://naschat.crowdin.com/naschat) or you can create a [GitHub issue](https://github.com/bluesky-social/social-app/issues).
